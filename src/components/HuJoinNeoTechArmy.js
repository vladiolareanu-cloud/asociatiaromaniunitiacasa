    ...
    <section id="join-rua">
      <div className="container">
        ...
        <div className={styles.uploadBox}>
         ...
         Töltsd fel a képedet, vagy készíts egy szelfit, ha telefonról vagy, és mi hozzáadjuk a vízjelünket.
Ezután letöltheted, és profilképként használhatod a közösségi oldalakon, hogy támogass minket.
Ha nem tetszik az előnézet, választhatsz egy másik képet.
Ezeket a képeket sehol sem tároljuk, így ha frissíted az oldalt, újra el kell végezned a folyamatot.
...
export default HuJoinNeoTechArmy;
