        ...
        <div className="footer_bottom">
          <div className="container">
            <div className="fb_in">
              ...
              <a className="originTextColor" href="/huabout">
                Rólunk
              </a>
             <a className="originTextColor" href="/huvoluntari">
                Önkéntesek
              </a>
            <a className="originTextColor" href="/hucazuri-sociale">
                Szociális esetek
              </a>
              <a className="originTextColor" href="/hucontact">
                Kapcsolat
              </a>
